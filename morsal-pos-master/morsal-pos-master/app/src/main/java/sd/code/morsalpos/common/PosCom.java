...
public class PosCom implements StructInterface{
	...
	public  byte[] sField40_oldTerNum = new byte[4]; 	// ԭ�����ն˺ź�3λ
	public  int iField48Len;
	public  byte[] sField48 = new byte[512]; 			// 48���Ž�������
	...
	public  int ucPrtflag; 								// ���׽������Ƿ��ӡƾ��
	public  int ucWriteLog; 							// ���׽������Ƿ����־
	public  int ucPointType; 							// �������� '0'����/'1'�ض�
	public  int ucRmbSettRsp; 							// ����ҿ�������
	public  int ucFrnSettRsp; 							// ��ҿ�������
	public  byte ucAmtSign; 							// ���������� '+' '-'
	public  byte[] sOrignTransInfo = new byte[31]; 		// ԭ������Ϣ�����������������õ�
	public  byte[] BalanceAmount = new byte[41]; 		// #48�ʻ���� an...020
	public  byte[] Track1 = new byte[88]; 				// #35 1�ŵ����� Z..37 u8 Track1[2+37];
	public  byte[] Track2 = new byte[39]; 				// #35 2�ŵ����� Z..37
	public  byte[] Track3 = new byte[109]; 				// #36 3�ŵ����� Z..104
	public  int Track1Len; 								// �ŵ�1����
	public  int Track2Len; 								// �ŵ�2����
	public  int Track3Len; 								// �ŵ�3����
	public  int IsSaveLogAndRev; 						// �Ƿ���Ҫ�������߱�����־
	public Pos8583PacketStrc stTrnTbl=new Pos8583PacketStrc(); 	// ���״�����Ƿ��ӡ�ȵ���Ϣ
	public LogStrc stTrans=new LogStrc();			 	// ����Ҫ����Ϣ����Ҫ��¼����־�е�����
	public  long HaveInputAmt; 							// ���ʽ����Ѿ������˽����
	public  int nRespIccLen; 							// ���ص�IC����֤����
	public  byte[] RespIccData = new byte[512];
	// EMV
	public  byte[] szCertData = new byte[23]; 			// type(2)ID no(20)
	public  int iReversalDE55Len;
	public  byte[] sReversalDE55 = new byte[128]; 		// �����ͽű�֪ͨ��BIT 55���� //11/06/15
	public  int iScriptDE55Len;
	public  byte[] sScriptDE55 = new byte[128]; 		// 11/06/15
