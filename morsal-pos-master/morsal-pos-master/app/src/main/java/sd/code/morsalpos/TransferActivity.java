...
import sd.code.morsalpos.barcode.BarcodeCaptureActivity;
...
import sd.code.morsalpos.process.TransferProcess;
...
public class TransferActivity extends AppCompatActivity {
    ...
    Button sumbit, scan;
    EditText iPin, toCard, amount, pan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), TransferActivity.this);
        ...
        toCard = (EditText) findViewById(R.id.input_pan_to);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(toCard.getText().toString())) {
                    toCard.setError(getString(R.string.error_empty_filed));
                    cancel = true;
                } else if (toCard.getText().toString().length() != 16 && toCard.getText().toString().length() != 19) {
                    toCard.setError(getString(R.string.error_invalid_card));
                    cancel = true;
                }
                ...
                if (!cancel) {
                    ...
                    String toCardStr = toCard.getText().toString();
                    ...
                    map.put("toCard", toCardStr);
                    map.put("tranAmount", amountStr);

                    Log.d(TAG, "Map: " + map.toString());
                    final ProgressDialog dialog = new ProgressDialog(TransferActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();
                    CallUrl callUrl = new CallUrl(Config.URL_TRANSFARE_CARD, new JSONObject(map)) {
                        @Override
                        public void afterRequest(JSONObject response) {
                            ...
                            try {
                                ...
                                String toCard = response.getString("toCard");
                            ...
                            new PromptDialog(TransferActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(TransferActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
...
//                            Log.e(TAG, "Error: "+error.networkResponse.data);
                            ...
                            Toast.makeText(TransferActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
        ...
        if (requestCode == BARCODE_READER_REQUEST_CODE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    toCard.setText(barcode.displayValue);
                } else result.setText(R.string.no_barcode_captured);
            } else Log.e("barcode fail", String.format(getString(R.string.barcode_error_format),
...
//        PrinterApi.PrnLogo_Api(resized);
        ...
        PrinterApi.PrnStr_Api("******* "+getString(R.string.card_transfare)+" ********");
        ...
        PrinterApi.PrnStr_Api(getString(R.string.amount)+": "+resMap.get("Amount"));

        PrinterApi.PrnStr_Api(getString(R.string.card_number)+" "+resMap.get("fromCard"));
        PrinterApi.PrnStr_Api(getString(R.string.to_card_number)+" "+resMap.get("toCard"));
