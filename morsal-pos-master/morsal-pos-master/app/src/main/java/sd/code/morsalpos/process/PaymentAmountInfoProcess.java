...
public class PaymentAmountInfoProcess extends AsyncTask<Void, Void, Void> {
    ...
    public PaymentAmountInfoProcess(Activity activity , PortalApplication application, View submit, CardInfo card, TextView txtResult,
