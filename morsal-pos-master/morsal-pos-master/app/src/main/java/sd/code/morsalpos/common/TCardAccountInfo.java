...
public class TCardAccountInfo implements StructInterface{
	public byte cardMode;  //��Ƭ���뷽ʽ
	public byte[] MainAcc = new byte[22];  //#2 ���ʺ� n..19
	public byte[] ExpDate = new byte[4];	//#14 ��Ч��  ��/��/��
	public byte[] HoldCardName = new byte[46];	//�ֿ�������
	public byte	bPanSeqNoOk;				// ADVT case 43 [3/31/2006 Tommy]
	public byte	ucPanSeqNo;					// App. PAN sequence number
	public byte Track1Len;					//�ŵ�1����
	public byte[] Track1 = new byte[88]; 					//#35 1�ŵ����� Z..37 	u8 Track1[2+37]; 
	public byte Track2Len;					//�ŵ�2����
	public byte[] Track2 = new byte[4+37]; 				//#35 2�ŵ����� Z..37   
	public byte Track3Len;					//�ŵ�3����
	public byte[] Track3 = new byte[2+107];				//#36 3�ŵ����� Z..104	
