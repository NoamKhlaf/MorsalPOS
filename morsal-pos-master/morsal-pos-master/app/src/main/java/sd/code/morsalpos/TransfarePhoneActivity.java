...
public class TransfarePhoneActivity extends AppCompatActivity {

    private final static String TAG = TransfarePhoneActivity.class.getSimpleName();
    View requestCode;


    PortalApplication application;
    Button sumbit;
    EditText iPin, toPhone, amount, pan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transfare_phone);
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), TransfarePhoneActivity.this);
        ...
        toPhone = (EditText) findViewById(R.id.input_phone);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.parseInt(amount.getText().toString()) % 10 != 0) {
                    amount.setError(getString(R.string.amount_must_be_gratter_10));
                    cancel = true;
                }
                if (Integer.parseInt(amount.getText().toString()) > 500 ) {
                    amount.setError("Maximum is 500 SDG ");
                    cancel = true;
                }

                if (TextUtils.isEmpty(toPhone.getText().toString())) {
                    toPhone.setError(getString(R.string.error_empty_filed));
                    cancel = true;
                } else if (toPhone.getText().toString().length() != 10) {
                    toPhone.setError(getString(R.string.error_invalid_account));
                    cancel = true;
                }
                ...
                if (!cancel) {
                    ...
                    String toPhoneStr = toPhone.getText().toString();
                    ...
                    map.put("phoneNumber", toPhoneStr);

                    Log.d(TAG, "Map: "+map.toString());
                    final ProgressDialog dialog = new ProgressDialog(TransfarePhoneActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();

                    CallUrl callUrl = new CallUrl(Config.URL_GENERATE_VOUCHER, new JSONObject(map)) {
                        @Override
                        public void afterRequest(JSONObject response) {
                            ...
                            new PromptDialog(TransfarePhoneActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(TransfarePhoneActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
                        @Override
                        public void onError(VolleyError error) {
                            ...
                            Toast.makeText(TransfarePhoneActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
