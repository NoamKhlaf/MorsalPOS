...
import sd.code.morsalpos.process.GenerateVoucherProcess;
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cancel) {
                    ...
                    new GenerateVoucherProcess(VoucherActivity.this, application, sumbit, card, result, mobile.getText().toString(), Double.parseDouble(amount.getText().toString())).execute();
