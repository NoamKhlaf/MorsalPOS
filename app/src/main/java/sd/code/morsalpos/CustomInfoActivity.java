...
public class CustomInfoActivity extends AppCompatActivity {
    final String TAG = CustomInfoActivity.class.getSimpleName();
...
//    PayeeListAdapter payeeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), CustomInfoActivity.this);
...
//                    String payeeId = payees.get(payeeList.getSelectedItemPosition()).getPayeeNumber();
                    String paymentInfo = bankCode.getText().toString();
                    ...
                    map.put("payeeId", "0010030003");

                    Log.d(TAG, "Map: " + map.toString());
                    final ProgressDialog dialog = new ProgressDialog(CustomInfoActivity.this, R.style.AppTheme_Dark_Dialog);
...
//"additionalData": "BankCode=0993594690;Amount=44;DeclarantNAME=mohAmEd AbD elgAdIr AlFadni;InstanceID=407017;ProcStatus=0;ProcErroe=no Error;Office=SUB00;Declarant=130011270100;DECNBER=801;Transaction=E;Year=2013;DECSER=E",
                            ...
                            new PromptDialog(CustomInfoActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(CustomInfoActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
...
//                            Log.e(TAG, "Error: "+error.networkResponse.data);
                            ...
                            Toast.makeText(CustomInfoActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
...
//
//                    new BillInfoProcess(CustomInfoActivity.this, application, sumbit, card, result, payeeId, paymentInfo).execute();
        ...
        PayeeTable payeeTable = new PayeeTable(CustomInfoActivity.this);
...
//        PrinterApi.PrnLogo_Api(resized);
        ...
        PrinterApi.PrnStr_Api("**** "+getString(R.string.title_activity_custom_info)+" ****");
...
//        resMap.put("payeeId", response.getString("payeeId"));
        ...
        PrinterApi.PrnStr_Api("Response Status: " + resMap.get("responseStatus"));
        PrinterApi.PrnStr_Api("Bank code: " + resMap.get("personalPaymentInfo"));
        ...
        PrinterApi.PrnStr_Api("Bank Code: " + resMap.get("BankCode"));
        PrinterApi.PrnStr_Api("Amount: " + resMap.get("Amount"));
        PrinterApi.PrnStr_Api("Declarant Name: " + resMap.get("DeclarantNAME"));
        PrinterApi.PrnStr_Api("Instance Id: " + resMap.get("InstanceID"));
        PrinterApi.PrnStr_Api("ProcStatus: " + resMap.get("ProcStatus"));
        PrinterApi.PrnStr_Api("ProcErroe: " + resMap.get("ProcErroe"));
        PrinterApi.PrnStr_Api("Office: " + resMap.get("Office"));
        PrinterApi.PrnStr_Api("Declarant: " + resMap.get("Declarant"));
        PrinterApi.PrnStr_Api("DECNBER: " + resMap.get("DECNBER"));
        PrinterApi.PrnStr_Api("Transaction: " + resMap.get("Transaction"));
        PrinterApi.PrnStr_Api("Year: " + resMap.get("Year"));
        PrinterApi.PrnStr_Api("DECSER: " + resMap.get("DECSER"));
