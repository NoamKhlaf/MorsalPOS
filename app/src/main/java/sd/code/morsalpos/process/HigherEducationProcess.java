...
public class HigherEducationProcess extends AsyncTask<Void, Void, Void> {
    ...
    public HigherEducationProcess(Activity activity , PortalApplication application, View submit, CardInfo card, TextView txtResult, String payeeId, String paymentInfo, double tranAmount, String extraInfo, View finish){
            ...
            if(application.getPublicKey() != null) {
                    ...
                    if(tranObj != null && tranObj.has("responseStatus") &&  tranObj.get("responseStatus").toString().equals("Successful") ){
                        ...
                        resultMessage   =  resources.getString(R.string.successful)+"... \n"+extraInfo+"\n"+
                                ...
                                resources.getString(R.string.student_name)+": "+billInfo.get("arabicName").toString()+" \n" +
