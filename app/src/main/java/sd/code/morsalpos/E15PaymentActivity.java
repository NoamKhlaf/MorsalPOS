...
public class E15PaymentActivity extends AppCompatActivity {
    final static String TAG = E15PaymentActivity.class.getSimpleName();
    ...
    Button sumbit;
    EditText iPin, phone, billNo, amount, pan;
    TextView result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.e15_payment);
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), E15PaymentActivity.this);
...
//                    final String payeeId = payees.get(payeeList.getSelectedItemPosition()).getPayeeNumber();
                    String paymentInfo = "6" + "/" + billNo.getText().toString() + "/" + phone.getText().toString();
                    ...
                    final ProgressDialog dialog = new ProgressDialog(E15PaymentActivity.this, R.style.AppTheme_Dark_Dialog);
                    ...
                    CallUrl callUrl = new CallUrl(Config.URL_BILL_PAYMENT, new JSONObject(map)) {
                        ...
                        public void afterRequest(JSONObject response) {
                            ...
                            new PromptDialog(E15PaymentActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(E15PaymentActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
...
//                            Log.e(TAG, "Error: "+error.networkResponse.data);
                            ...
                            Toast.makeText(E15PaymentActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
...
//                    String paymentInfo = "6" + "/" + billNo.getText().toString() + "/" + phone.getText().toString();
//                    String extraInfo = getResources().getString(R.string.bill_no) + ": " + billNo.getText().toString() + "\n" +
//                            getResources().getString(R.string.prompt_phone) + ": " + phone.getText().toString();

//                    if (amount.getText() != null && !amount.getText().toString().equals(""))
//                        new PaymentProcess(E15PaymentActivity.this, application, sumbit, card, result, payeeId, paymentInfo, Double.parseDouble(amount.getText().toString()), extraInfo).execute();
        ...
        PayeeTable payeeTable = new PayeeTable(E15PaymentActivity.this);
...
//        PrinterApi.PrnLogo_Api(resized);
        ...
        PrinterApi.PrnStr_Api("******* "+getString(R.string.title_activity_e15)+" ********");
