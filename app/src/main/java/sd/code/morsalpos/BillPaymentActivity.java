...
public class BillPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), BillPaymentActivity.this);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cancel) {
                    ...
                    final ProgressDialog dialog = new ProgressDialog(BillPaymentActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();

                    BillPaymentProcess process = new BillPaymentProcess(BillPaymentActivity.this, map) {
                        @Override
                        public void onResponse(JSONObject response) {
                            ...
                            new PromptDialog(BillPaymentActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(BillPaymentActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
                        ...
                        public void onErrorOccur(VolleyError error) {
                            ...
                            Toast.makeText(BillPaymentActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    process.execute();
                } else {
        ...
        PayeeTable payeeTable = new PayeeTable(BillPaymentActivity.this);
