...
public class PurchaseReversalActivity extends AppCompatActivity{

    private final String TAG = PurchaseReversalActivity.class.getSimpleName();
    public static ArrayList<PayeeInfo> payees = new ArrayList<PayeeInfo>() ;

    PortalApplication application ;
    Button submit;
    EditText iPin,  amount,pan  , originalTranSTAN;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), PurchaseReversalActivity.this);
        ...
        originalTranSTAN = (EditText) findViewById(R.id.originalTranSTAN);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!cancel) {
                    ...
                    String originalTranSTANStr = originalTranSTAN.getText().toString();
                    ...
                    map.put("serviceId", "2");
                    map.put("originalTranSTANStr", originalTranSTANStr);



                    Log.d(TAG, "Map: " + map.toString());
                    final ProgressDialog dialog = new ProgressDialog(PurchaseReversalActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();
                    CallUrl callUrl = new CallUrl(Config.URL_REVERSE, new JSONObject(map)) {
                        @Override
                        public void afterRequest(JSONObject response) {
                            ...
                            try {
                                ...
                                resMap.put("responseStatus", response.getString("responseStatus"));
                                resMap.put("responseCode", response.getString("responseCode"));

                                resMap.put("responseCode", response.getString("responseCode"));
                                resMap.put("terminalId", response.getString("terminalId"));
                                resMap.put("serviceId", response.getString("serviceId"));
                                resMap.put("originalTranSystemTraceAuditNumber", response.getString("originalTranSystemTraceAuditNumber"));
                            ...
                            new PromptDialog(PurchaseReversalActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(PurchaseReversalActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
                        @Override
                        public void onError(VolleyError error) {
                            ...
                            Toast.makeText(PurchaseReversalActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
