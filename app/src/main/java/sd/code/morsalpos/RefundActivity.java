...
public class RefundActivity extends AppCompatActivity{
    private final static String TAG = RefundActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), RefundActivity.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!cancel) {
                    ...
                    final String amouuntStr = amount.getText().toString();
                    ...
                    map.put("tranAmount", amouuntStr);

                    Log.d(TAG, "Map: " + map.toString());
                    final ProgressDialog dialog = new ProgressDialog(RefundActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();
                    CallUrl callUrl = new CallUrl(Config.URL_REFUND, new JSONObject(map)) {
                        @Override
                        public void afterRequest(JSONObject response) {
                            dialog.dismiss();
                            String content = "";
                            try {
                                resMap.put("approvalCode", response.getString("approvalCode"));
                                resMap.put("responseStatus", response.getString("responseStatus"));
                                resMap.put("terminalId", response.getString("terminalId"));
                                resMap.put("tranCurrencyCode", response.getString("tranCurrencyCode"));
                                resMap.put("additionalAmount", response.getString("additionalAmount"));
                                resMap.put("tranAmount", response.getString("tranAmount"));
                                resMap.put("transactionId", response.getString("transactionId"));
                                ...
                                resMap.put("tranFee", response.getString("tranFee"));
                            ...
                            new PromptDialog(RefundActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            dialog.dismiss();
                                            PrtCardInfo();
                                            Toast.makeText(RefundActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
...
//                            Log.e(TAG, "Error: "+error.networkResponse.data);
                            ...
                            Toast.makeText(RefundActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
...
//        PrinterApi.PrnLogo_Api(resized);
        ...
        PrinterApi.PrnStr_Api("**** "+getString(R.string.refund)+" *****");
