...
public class BillInquiryActivity extends AppCompatActivity {
    private static final String TAG = BillInquiryActivity.class.getSimpleName();
    View requestCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), BillInquiryActivity.this);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cancel) {
                    ...
                    map.put("personalPaymentInfo", mobileStr);
                    map.put("payeeId", payeeId);

                    Log.d(TAG, "Map: " + map.toString());
                    final ProgressDialog dialog = new ProgressDialog(BillInquiryActivity.this, R.style.AppTheme_Dark_Dialog);
                    ...
                    CallUrl callUrl = new CallUrl(Config.URL_BILL_INQUIRY, new JSONObject(map)) {
                        ...
                        public void afterRequest(JSONObject response) {
                            ...
                            new PromptDialog(BillInquiryActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(BillInquiryActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
...
//                            Log.e(TAG, "Error: "+error.networkResponse.data);
                            ...
                            Toast.makeText(BillInquiryActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    callUrl.execute();
        ...
        PayeeTable payeeTable = new PayeeTable(BillInquiryActivity.this);

        payees.clear();
        payees.addAll(payeeTable.getPayeesByType(PayeeType.PAYEE_TYPE_BILL_PAYMENT));
...
//        PrinterApi.PrnLogo_Api(resized);
        ...
        if(resMap.get("payeeId").equals("0010010004")){ // MTN
            // "Status=Success;ContractNumber=1035369354;BillAmount=-109326.325;UnbillAmount=500;InvoiceDate=20150228000000",
            try {
                ...
                PrinterApi.PrnStr_Api(getString(R.string.billAmount)+": " + resMap.get("BillAmount"));
                PrinterApi.PrnStr_Api(getString(R.string.unbilledAmount)+": " + resMap.get("UnbillAmount"));
                PrinterApi.PrnStr_Api(getString(R.string.invoice_date)+" " + resMap.get("InvoiceDate"));
            } catch (Exception e){
                e.printStackTrace();
            }
        } else if(resMap.get("payeeId").equals("0010010005")){ // Zain
            // "Status=Success;ContractNumber=1035369354;BillAmount=-109326.325;UnbillAmount=500;InvoiceDate=20150228000000"
            try {
                PrinterApi.PrnStr_Api(getString(R.string.status)+" " + resMap.get("Status"));
                PrinterApi.PrnStr_Api(getString(R.string.contract_number)+": " + resMap.get("ContractNumber"));
        ...
        } else if(resMap.get("payeeId").equals("0010010005")) { // Sudani
            // "Status=Success;ContractNumber=878847096;BillAmount=265.934"
            try {
                PrinterApi.PrnStr_Api(getString(R.string.status)+": " + resMap.get("Status"));
                PrinterApi.PrnStr_Api(getString(R.string.contract_number)+": " + resMap.get("ContractNumber"));
                PrinterApi.PrnStr_Api(getString(R.string.billAmount)+": " + resMap.get("BillAmount"));
