...
import sd.code.morsalpos.process.HigherEducationProcess;
import sd.code.morsalpos.process.PaymentAmountInfoProcess;

public class HigherEducationActivity extends AppCompatActivity {
    final static String TAG = HigherEducationActivity.class.getSimpleName();
    ...
    EditText iPin, seatNo, pan, amount;
    TextView txtAmount;
    TextView result;
    View view1, view2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatNo = (EditText) findViewById(R.id.input_seat_no);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(seatNo.getText().toString())) {
                    seatNo.setError(getString(R.string.error_empty_filed));
                    cancel = true;
                }
                ...
                if (!cancel) {
                    ...
                    String personalPaymentInfo = seatNo.getText().toString() + "/" + courses.get(courseList.getSelectedItemPosition()).getId() + "/" + formKinds.get(formKindList.getSelectedItemPosition()).getId();
                    ...
                    final ProgressDialog dialog = new ProgressDialog(HigherEducationActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();

                    BillPaymentProcess process = new BillPaymentProcess(HigherEducationActivity.this, map) {
                        @Override
                        public void onResponse(JSONObject response) {
                            ...
                            new PromptDialog(HigherEducationActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(HigherEducationActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
                        ...
                        public void onErrorOccur(VolleyError error) {
                            ...
                            Toast.makeText(HigherEducationActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
                        }
                    };
                    process.execute();
...
//                    String paymentInfo = "SETNUMBER=" + seatNo.getText().toString() + "/" + "STUDCOURSEID=" + courses.get(courseList.getSelectedItemPosition()).getId() + "/" + "STUDFORMKIND=" + formKinds.get(formKindList.getSelectedItemPosition()).getId();
//                    String extraInfo = getResources().getString(R.string.student_seat_number) + ": " + seatNo.getText().toString() + " \n" +
...
//
//                    new PaymentAmountInfoProcess(HigherEducationActivity.this, application, sumbit, card, result, payeeId, paymentInfo, txtAmount, extraInfo, view1, view2).execute();
        ...
        PayeeTable payeeTable = new PayeeTable(HigherEducationActivity.this);

        payees.clear();
        payees.addAll(payeeTable.getPayeesByType(PayeeType.PAYEE_TYPE_Higher_Education));
        payeeAdapter = new PayeeListAdapter(this, payees);
        payeeList.setAdapter(payeeAdapter);

        StudentCourseTable courseTable = new StudentCourseTable(HigherEducationActivity.this);
        ...
        FormKindTable formKindTable = new FormKindTable(HigherEducationActivity.this);
