...
public class TopupActivity extends AppCompatActivity {
    ...
    Button sumbit;
    EditText iPin, mobile, amount, pan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurDir + "/" + "\0"), TopupActivity.this);
        ...
        sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mobile.getText().length() != 10) {
                    mobile.setError(getString(R.string.error_invalid_mobile_number));
                    cancel = true;
                }
                ...
                if (!cancel) {
                    ...
                    String personalPaymentInfo = mobile.getText().toString();
                    ...
                    Log.d("TopupActivity", "Map: "+map.toString());
                    final ProgressDialog dialog = new ProgressDialog(TopupActivity.this, R.style.AppTheme_Dark_Dialog);
                    dialog.setMessage("Running...");
                    dialog.setCancelable(false);
                    dialog.show();

                    BillPaymentProcess process = new BillPaymentProcess(TopupActivity.this, map) {
                        @Override
                        public void onResponse(JSONObject response) {
                            ...
                            new PromptDialog(TopupActivity.this)
                                    ...
                                    .setPositiveListener("Print", new PromptDialog.OnPositiveListener() {
                                        ...
                                        public void onClick(PromptDialog dialog) {
                                            ...
                                            Toast.makeText(TopupActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                                        }
                                    }).show();
                        }
                        ...
                        public void onErrorOccur(VolleyError error) {
                            ...
                            Toast.makeText(TopupActivity.this, "Error occur.", Toast.LENGTH_SHORT).show();
        ...
        DatabaseHandler db = new DatabaseHandler(TopupActivity.this);

        PayeeTable payeeTable = new PayeeTable(TopupActivity.this);

        payees.clear();
        payees.addAll(payeeTable.getPayeesByType(PayeeType.PAYEE_TYPE_TOPUP));
    ...
    public void PrtCardInfo() {
        ...
        PrinterApi.PrnStr_Api("********* Bill Payment ********");
        ...
        PrinterApi.PrnStr_Api("Mobile Number: " + resMap.get("personalPaymentInfo"));
        PrinterApi.PrnStr_Api("Voucher  Amount: " + resMap.get("tranAmount"));
